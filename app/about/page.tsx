...
const values = [
  {
    icon: Heart,
    title: "Writer-First",
    description: "Every feature helps writers create better work.",
  },
  {
    icon: Zap,
    title: "Powerful Simplicity",
    description: "Best tools are invisible and stay out of your way.",
  },
  {
    icon: Shield,
    title: "Privacy First",
    description: "Your words belong to you. Strong privacy measures.",
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
              Building the future of creative writing—where AI amplifies human
              creativity.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 md:p-12">
              ...
              <p className="text-lg text-zinc-300 leading-relaxed">
                UNIX was born from a simple observation: writers deserve better
                tools. We set out to create the most thoughtful, powerful, and
                beautiful writing environment ever made—one that understands
                your work and helps you achieve your creative vision.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {[
              { v: "10K+", l: "Writers" },
              { v: "50K+", l: "Projects" },
              { v: "1M+", l: "Words Written" },
              { v: "99.9%", l: "Uptime" },
            ].map((s, i) => (
              <div
                key={i}
                className="p-6 bg-zinc-900/30 border border-zinc-800/50 rounded-2xl text-center"
              >
