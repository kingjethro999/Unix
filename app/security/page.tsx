...
const features = [
  ...
  },
  {
    ...
    description:
      "Our servers are hosted in SOC 2 compliant data centers with 24/7 monitoring.",
  },
  {
    icon: Eye,
  ...
  },
  {
    ...
    description:
      "Support for strong passwords, two-factor authentication, and SSO integration.",
  },
  {
    icon: RefreshCw,
  ...
  },
  {
    icon: Shield,
    title: "Data Backup",
    description: "Automated encrypted backups ensure your work is never lost.",
  },
];
      ...
      <main className="pt-32 pb-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 mb-16"
          >
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-violet-600/10 to-purple-600/10 border border-violet-500/20 rounded-2xl p-8 text-center"
          >
            <h2 className="text-xl font-semibold mb-4">
              Report a Vulnerability
            </h2>
            <p className="text-zinc-400 mb-6">
              Found a security issue? We appreciate responsible disclosure and
              will respond promptly.
            </p>
            <a
              href="mailto:security@unix.app"
