        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 mb-12 max-w-2xl mx-auto leading-relaxed">
              We're crafting the perfect pricing plans to match every writer's
              journey. From hobbyists to professional authors, we'll have
          ...
          >
            ...
            <div className="relative bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl p-12">
              ...
              <p className="text-zinc-400 mb-8 max-w-md mx-auto">
                Our team is working hard to bring you flexible and fair pricing
                options. Stay tuned for exciting announcements!
              </p>
          ...
          >
            {[
              {
                title: "Free Tier",
                desc: "Perfect for getting started with UNIX",
              },
              { title: "Pro Plan", desc: "For All writers and authors" },
              {
                title: "Team Plan",
                desc: "Collaborate with your writing team",
              },
            ].map((plan, i) => (
              <div
                key={i}
