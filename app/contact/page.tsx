                ...
                {[
                  {
                    ...
                    href: "mailto:jethrojerrybj@gmail.com",
                  },
                  {
                    icon: MessageSquare,
                    title: "Support",
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-xl text-white focus:outline-none focus:border-violet-500 resize-none"
