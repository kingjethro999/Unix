...
const steps = [
  {
    ...
    description:
      "Sign up for UNIX with your email or connect with your favorite authentication provider. Your account gives you access to all features and syncs across devices.",
    action: "Sign Up Now",
    href: "/sign-up",
  },
  {
    ...
    description:
      "Create your first writing project. Choose from templates like novels, short stories, screenplays, or start with a blank canvas tailored to your needs.",
  ...
  },
  {
    ...
    description:
      "Use our rich text editor to write your content. Enjoy features like auto-save, version history, and seamless formatting that stays out of your way.",
  ...
  },
  {
    ...
    description:
      "Open the AI sidebar to get writing suggestions, overcome blocks, analyze your text, and maintain consistency throughout your manuscript.",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
              Begin your journey with UNIX in just a few simple steps. You'll be
              writing with AI-powered assistance in no time.
            </p>
          </motion.div>
