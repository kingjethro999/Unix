...
const changelog = [
  {
    ...
    changes: [
      {
        icon: Sparkles,
        text: "AI-powered writing assistant with context awareness",
      },
      {
        icon: Sparkles,
        text: "Rich text editor with modern formatting options",
      },
  ...
  },
  {
    ...
    changes: [
      ...
      {
        icon: Sparkles,
        text: "Added export functionality for PDF, EPUB, DOCX",
      },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
              Track our progress and see what's new in UNIX. We're constantly
              improving to make your writing experience better.
            </p>
          </motion.div>
