...
const futureVision = [
  {
    icon: Brain,
    title: "Advanced AI",
    desc: "Deeper character and plot analysis",
  },
  { icon: Globe, title: "Localization", desc: "Support for 20+ languages" },
  {
    icon: Users,
    title: "Community",
    desc: "Writer forums and critique groups",
  },
  {
    icon: Smartphone,
    title: "Everywhere",
    desc: "Write on any device, anytime",
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {roadmapItems.map((phase, index) => (
              <motion.div
                ...
                className={`relative bg-zinc-900/50 backdrop-blur-xl border rounded-2xl p-6 ${
