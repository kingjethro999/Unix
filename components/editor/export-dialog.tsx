        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setOptions({ ...options, format: value as "pdf" | "docx" })
              }
            >
              <SelectTrigger
                id="format"
          ...
          <div className="space-y-4 border-t border-zinc-800 pt-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label htmlFor="fontSize" className="text-zinc-300">
                  Font Size
                </Label>
                <Input
                  id="fontSize"
              ...
              <div className="space-y-2">
                <Label htmlFor="lineSpacing" className="text-zinc-300">
                  Line Spacing
                </Label>
                <Select
              ...
              <div className="space-y-2">
                <Label htmlFor="pageSize" className="text-zinc-300">
                  Page Size
                </Label>
                <Select
