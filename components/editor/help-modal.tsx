              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden max-h-[80vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-thin scrollbar-thumb-zinc-800">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Interact with the AI sidebar to brainstorm, draft, or
                        edit your work. Drag files into the chat to provide
                        context. The AI is aware of your entire project
                        structure.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-sm font-semibold text-zinc-200">
                        The .unixrc Style Guide
                      </h3>
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Every workspace comes with a{" "}
                        <code className="text-indigo-400 bg-indigo-500/10 px-1.5 py-0.5 rounded text-xs font-mono">
                          .unixrc
                        </code>{" "}
                        file. Define your style rules here (e.g., "No adverbs",
                        "First person POV"). The AI analyzes this file before
                        every response to ensure consistency.
                        <span className="block mt-1 text-xs text-zinc-500 italic">
                          This file is automatically excluded from exports.
                        </span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        When the AI updates files, changes are proposed in
                        "Review Mode". You'll see a global review bar at the
                        bottom of the chat with precise addition/deletion stats.
                        You can <strong>Accept</strong> or{" "}
                        <strong>Reject</strong> changes individually or in bulk.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 opacity-60">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-sm font-semibold text-zinc-200">
                        Live Collaboration
                        <span className="ml-2 text-[10px] px-2 py-0.5 bg-purple-500/20 text-purple-300 rounded-full font-medium">
                          Coming Soon
                        </span>
                      </h3>
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Real-time collaboration with team members will be added
                        in the next major update. Work together on documents
                        with live cursors, comments, and shared editing
                        sessions.
                      </p>
                    </div>
                  </div>
